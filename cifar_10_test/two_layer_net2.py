...
class TwoLayerNet:
    def __init__(self, input_size, hidden_size,hidden_size2, output_size, weight_init_std=0.01):
        ...
        self.params['B'] = weight_init_std * np.random.randn(output_size)
        ...
        self.layers['Affine1'] = Affine(self.params['W'], self.params['B'])
    ...
    def gradient(self, x, t):
        ...
        # 결과 저장
        grads = {}
        grads['W'], grads['B'] = self.layers['Affine1'].dW, self.layers['Affine1'].db
