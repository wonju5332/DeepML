...
class TwoLayerNet:
    def __init__(self, input_size, hidden_size, output_size, weight_init_std=0.4):
        ...
        self.layers['Batch1'] = BatchNormalization(gamma=1.0, beta=0.)
        self.layers['Relu1'] = Relu()
        self.layers['Affine2'] = Affine(self.params['W2'], self.params['b2'])
        self.layers['Batch2'] = BatchNormalization(gamma=1.0, beta=0.)
        self.layers['Relu2'] = Relu()
        self.layers['Affine3'] = Affine(self.params['W3'], self.params['b3'])
        self.layers['Batch3'] = BatchNormalization(gamma=1.0, beta=0.)
        self.layers['Relu3'] = Relu()
        self.layers['Affine4'] = Affine(self.params['W4'], self.params['b4'])
        self.layers['Batch4'] = BatchNormalization(gamma=1.0, beta=0.)
