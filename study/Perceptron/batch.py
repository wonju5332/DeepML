...
accuracy_cnt = 0
batch_size = 100   # 배치크기 100  # 1 = 4.864 , 100   , 0.55


# print(x[0])  #숫자 5를 표현하는 784개의 픽셀
print(x[0:2])  #필기체 숫자 5와 7을 표현하는 픽셀 ( 784 개 + 784 개 )가 출력이 된다.
# print(t[0])

# print(list(range(0, 10000, 100)))
for i in range(0, len(x), batch_size):
    x_batch = x[i:i+batch_size]  #i=0일 x[0:0+100] , i=100일때, x[100:100+100]...
